...
export const binPayouts: Record<RowCount, Record<RiskLevel, number[]>> = {
  8: {
    [RiskLevel.LOW]: [0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9],
    [RiskLevel.MEDIUM]: [13, 3, 1.3, 0.7, 0.4, 0.7, 1.3, 3, 13],
    [RiskLevel.HIGH]: [29, 4, 1.5, 1.2, 0.2, 0.3, 1.5, 4, 29],
  },
  9: {
  ...
  16: {
    ...
    [RiskLevel.HIGH]: [700000, 600000, 500000, 400000, 300000, 200000, 100000, 10000, 1000, 10000, 100000, 200000, 300000, 400000, 500000, 600000, 700000],
  },
};
